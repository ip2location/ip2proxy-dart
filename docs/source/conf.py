...
myst_html_meta = {
    "description": "IP2Proxy Dart Package enables user to query an IP address if it was being used as open proxy, web proxy, VPN anonymizer and TOR exits.",
    "keywords": "IP2Proxy, Proxy, IP location, Dart",
...
html_title = "IP2Proxy Dart"

# html_baseurl = "https://ip2proxy-dart.readthedocs.io/en/latest/"